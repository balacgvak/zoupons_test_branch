    ...
    class MyOnGlobalLayoutListener implements OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            for (int i = 0; i < children.length; i++) {
                ...
                System.out.println("scrollToViewIdx : "+scrollToViewIdx);
                ...
                System.out.println("scrollToViewPos : "+scrollToViewPos);
            }
            ...
            new Handler().post(new Runnable() {
                @Override
                public void run() {
                    Log.i("MyHorizontalScrollView","scrollToViewPos : "+scrollToViewPos);
