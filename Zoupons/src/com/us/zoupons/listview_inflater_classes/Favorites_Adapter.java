...
/**
 * 
 * Adapter to list favorite stores
 *
 */
...
public class Favorites_Adapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.mFavouritesStoreCategory.setText(mFavouriteStoreDetails.store_category+" / "+mFavouriteStoreDetails.store_subcategory);
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(mClassName.equals("Favorites")){
					...
					MainMenuActivity.sRightMenu.setVisibility(View.VISIBLE);
					int right = menuWidth+menuWidth;
					MainMenuActivity.sScrollView.smoothScrollTo(right, 0);
					...
					if(mPageFlag.equalsIgnoreCase("giftcard")){
		    			if(mStoreInformation.has_giftcard.equalsIgnoreCase("yes")){
		    				...
		    				Intent intent_giftcard_zcard = new Intent(FavoritesContext,StoreCardDetails.class);
		    			...
		    			if(mStoreInformation.has_point_of_sale.equalsIgnoreCase("yes")){
		    				//Move to step2
		    				Intent intent_step2 = new Intent(FavoritesContext,MobilePay.class);
