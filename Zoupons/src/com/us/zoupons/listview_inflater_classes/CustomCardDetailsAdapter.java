...
public class CustomCardDetailsAdapter extends BaseAdapter{
	private String TAG="CustomCardDetailsAdapter";
	...
	private String FriendId,mIsZouponsFriend,mFriendEmailAddress;
	public static String mSendGiftCardType="";
	
	public CustomCardDetailsAdapter(Activity context, int cardlistRow, String ServiceFunction, ArrayList<Object> mStoreRegularCardDetails, String friendName, String FriendId, String IsZouponsFriend,String FriendEmailId) {
		...
		this.mFriendEmailAddress = FriendEmailId;
		...
		if(mCardDetailsObject != null) {
			...
			holder.mBuyButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(mFriendEmailAddress.equalsIgnoreCase("")){
						...
						mMenuList.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> arg0,View arg1, int position, long arg3) {
								...
								if(mBuyOptions[position].equalsIgnoreCase("  Send to Friend")){
									Intent intent_friendlist = new Intent(mContext,FriendList.class);
									intent_friendlist.putExtra("classname", "SendGiftCard");	//Dummy classname for friends note description page for both sRightmenu giftcard and deals
						...
						friendnotecall.putExtra("classname","SendGiftCard");	//Dummy classname for friends note description page for both sRightmenu giftcard and deals
						friendnotecall.putExtra("sendto", FriendId);
						friendnotecall.putExtra("eventflag", mIsZouponsFriend);
						friendnotecall.putExtra("friend_emailaddress", mFriendEmailAddress);
