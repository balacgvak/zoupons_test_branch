 ...
 * 
 */
package com.us.zoupons.collections;
...
/**
 * Class consisting array list to add webservice returning values
 * 
 */
public class WebServiceStaticArrays {
	...
	public static ArrayList<Object> mStoreRegularCardDetails = new ArrayList<Object>();	//Array List for MyGiftCards
	public static ArrayList<Object> mStoreZouponsDealCardDetails = new ArrayList<Object>();	//Array List for Deals	
	public static ArrayList<POJOFBfriendListData> mSocialNetworkFriendList = new ArrayList<POJOFBfriendListData>();	// Array List for FB friends
	...
	public static ArrayList<POJOFBfriendListData> mSearchedFriendList = new ArrayList<POJOFBfriendListData>();	// Array List for Share_Store
    ...
    public static ArrayList<Object> mNotificationsResponseList = new ArrayList<Object>();
