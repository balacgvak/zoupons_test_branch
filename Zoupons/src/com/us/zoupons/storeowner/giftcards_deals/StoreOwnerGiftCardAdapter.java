...
/**
 * 
 * Custom adapter class to populate store giftcards
 *
 */
...
public class StoreOwnerGiftCardAdapter extends BaseAdapter{
	...
	private LayoutInflater mStoreOwnerGiftCardsInflater;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// Get card details from collection's respective position for each listview row
		final POJOCardDetails mCardDetailsObject = (POJOCardDetails) mCardList.get(position);
		if(mClassName.equalsIgnoreCase("Regular")){ // For Giftcards
