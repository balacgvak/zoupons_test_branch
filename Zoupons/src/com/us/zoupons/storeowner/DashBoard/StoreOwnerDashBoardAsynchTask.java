...
public class StoreOwnerDashBoardAsynchTask extends AsyncTask<String, String, String>{
	...
	ListView mListView;
	private String TAG="StoreOwnerDashBoardAsynchTask";

	public StoreOwnerDashBoardAsynchTask(Context context,String progressStatus,ListView listview) {
	...
	protected void onPostExecute(String result) {
		...
		try{
			...
			if(result.equals("nonetwork")){
				...
				Log.i(TAG,"Success: ");
				MenuUtilityClass.StoreOwnerDashBoardListView(mContext, mListView);
			}
		}catch (Exception e) {
			e.printStackTrace();
		}
