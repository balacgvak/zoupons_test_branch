...
/**
 * 
 * Custom Location list adapter to populate store locations with status [Active/Inactive/Pending]
 *
 */

public class StoreLocationsAdapter extends BaseAdapter{
	private LayoutInflater mStoreLocationsInflater;
	private ArrayList<Object> mStoreLocationList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		try{
			...
			// To fetch location details for each listview row
			...
			}else if(mStoreLocationDetails.status.equalsIgnoreCase("pending_active") || mStoreLocationDetails.status.equalsIgnoreCase("pending_inactive")){
