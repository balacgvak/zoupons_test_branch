...
/**
 * 
 * Asynchronous task to communicate with webservice to process payment
 *
 */
...
public class ApprovePaymentUsingMobileNumber extends AsyncTask<String, String, String> {
	...
	protected String doInBackground(String... params) {
		...
		try{
			if(mConnectionAvailabilityChecking.ConnectivityCheck(this.mContext)){ // Network connectivity check
