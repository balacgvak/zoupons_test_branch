...
public class SellGiftcardTask extends AsyncTask<String, String, String>{
	...
	public SellGiftcardTask(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		if(result.equals("nonetwork")){
			...
			alertBox_service("Information", "Thank You.Your wallet is now securely closed and giftcard send to your account");			
		}
	}
